...
template <class T> class Vec 
   ...
   // 12-13
   template<class In> Vec& assign(In, In);
...
template <class T>
template <class In>
void Vec<T>::insert(typename Vec<T>::iterator pos, In first, In last) 
   {
